...
BarWidget {
  ...
  // This custom tray never collapses icons: every active tray item is shown.
  readonly property var pinnedItems: bucket("all")
  ...
  function classifyItem(item) {
    ...
    // This bar has ample room: show new tray items immediately instead of
    // putting them behind the expandable drawer.
    return "pinned"
  }
